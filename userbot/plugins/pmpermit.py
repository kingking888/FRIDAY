...
USER_BOT_NO_WARN = ("[┏┓━┏┓━━━┓━┓ /n┃┃━┃┃━━━┃━┃ /n┃┗━┛┃━━┓┃━┃━━━┓ /n┃┏━┓┃┏┓┃┃━┃━┏┓┃ /n┃┃━┃┃┃━┫┗┓┗┓┗┛┃ /n┗┛━┗┛━━┛━┛━┛━━┛](https://github.com/midhunkm1294-bit/FRIDAY)\n\n"
        ...
        if event.is_private:
          if chat.id == 953414679:
            ...
            if pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit(" ███████▄▄███████████▄  \n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓███░░░░░░░░░░░░█\n██████▀▀▀█░░░░██████▀  \n░░░░░░░░░█░░░░█  \n░░░░░░░░░░█░░░█  \n░░░░░░░░░░░█░░█  \n░░░░░░░░░░░█░░█  \n░░░░░░░░░░░░▀▀ \n\n**This is FRIDAY AI..U HAVE BEEN BANNED DUE TO BACKCHODHI**..[{}](tg://user?id={})".format(firstname, chat.id))
                await asyncio.sleep(3)
...
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chat.id):
            pmpermit_sql.approve(chat.id, "**My master is alive**")
            await borg.send_message(chat, "**My master is come....U are Lucky gay **")
